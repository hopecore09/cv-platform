...
import Layout from './components/Layout'  // ← БЕЗ { }
...
const Recruiter = ({ children }) => 
  ['recruiter', 'admin'].includes(user()?.role) ? children : <Navigate to="/" />
        ...
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="positions" element={
              <Suspense fallback={<Loader />}><Positions /></Suspense>
            } />
            <Route path="positions/:id" element={
              <Suspense fallback={<Loader />}><PositionView /></Suspense>
            } />
            <Route path="positions/new" element={
              <Suspense fallback={<Loader />}>
                <Recruiter><PositionForm /></Recruiter>
              </Suspense>
            } />
            ...
            <Route path="attributes" element={
              <Suspense fallback={<Loader />}>
                <Recruiter><Attributes /></Recruiter>
              </Suspense>
            } />
            <Route path="cv/:id" element={
              <Suspense fallback={<Loader />}>
                <Private><CVPage /></Private>
              </Suspense>
            } />
